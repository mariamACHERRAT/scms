...
<div style="margin-top:20px;margin-left:86%;"><a href="{{ route('course.create') }}" class="focus:outline-none text-white bg-emerald-700  focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " >ADD COURSE</a>
</div>
