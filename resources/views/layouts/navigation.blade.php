    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <?php $user =Auth::user()?>
                @if ($user->is_admin)
                    <x-nav-link :href="route('student_list')" :active="request()->routeIs('dashboard')" class="text-black">
                        {{ __('Student List') }}
                    </x-nav-link>

                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">
                    <x-nav-link :href="route('teacher_list')" :active="request()->routeIs('dashboard')" class="text-black">
                        {{ __('Teacher List') }}
                    </x-nav-link>
                    @endif
                </div>
