...
<x-app-layout>
<div class=" mt-9 ml-2 "><a href="{{ route('student.create') }}" class="focus:outline-none text-white bg-fuchsia-700 hover:bg-fuchsia-700 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">ADD STUDENT</a></div>
